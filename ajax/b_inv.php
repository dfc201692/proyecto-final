<?php
	...
	if (isset($_GET['id'])){
		$idd=intval($_GET['id']);
			if ($delete1=mysqli_query($con,"DELETE FROM investigadores_proyecto WHERE investigador='".$idd."'")){
			?>
			  ...
			  <table class="table">
				...
				while ($row=mysqli_fetch_array($query)){
					...
					<tr>
						...
						<td><?php echo $rol; ?></td>
						<td><button type="button" class="btn btn-info"  onclick="eliminar(<?php echo $investigador; ?>);">
