    ...
    font-size: 18px;
        ...
        <div class="row">
          <div class="col-md-12">
            ...
            <button type="button" class="btn btn-info" style="float:right;"  data-toggle="modal" data-target="#nuevoCordinador">
             <span class="glyphicon glyphicon-plus"></span> Nuevo coordinador
            </button>
          </div>
          <form class="form-horizontal" role="form" id="">
            ...
            <div class="form-group row">
              ...
              <div class="col-md-8">
                <input type="text" class="form-control" id="q" placeholder="Nombre del coordinador" onkeyup='load(1);'>
              </div>
          ...
          <div id="resultados_ajax2"></div><!-- Carga los datos ajax -->
